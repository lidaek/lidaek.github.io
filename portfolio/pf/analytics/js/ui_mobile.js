...
// CMC_README: 추가 끝
    ...
    $('.btnTable').click(function () {
        $('.mData').toggleClass('typePlatform');
        return false;
    });

    $('.mKeyword .menu button').click(function () {
        $(this).parents('.menu').toggleClass('show');
        if ($(this).parents('.menu').hasClass('show')) {
            $(this).children('span').text('닫기');
        }else {
            $(this).children('span').text('통계 더보기');
        }
    });

    $('.mTab.typeButton a').click(function () {
    ...
    function checkForInput(element) {
        const $parent = $(element).parent('.mSearch');
    ...
    $('.mSearch input').each(function() {
        checkForInput(this);
    });

    $('.mSearch input').on('change keyup', function() {
        checkForInput(this);
    });

    $('.mSearch .btnDel').click(function(){
